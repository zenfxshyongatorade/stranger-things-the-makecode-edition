...
sprites.onOverlap(SpriteKind.Player, SpriteKind.collectible, function (sprite, otherSprite) {
    ...
    music.playSoundEffect(music.createSoundEffect(WaveShape.Noise, 5000, 1, 255, 213, 500, SoundExpressionEffect.Warble, InterpolationCurve.Logarithmic), SoundExpressionPlayMode.UntilDone)
    page.destroy()
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.collectable, function (sprite4, otherSprite3) {
    info.changeScoreBy(1)
    music.playSoundEffect(music.createSoundEffect(WaveShape.Noise, 5000, 1, 255, 213, 500, SoundExpressionEffect.Warble, InterpolationCurve.Logarithmic), SoundExpressionPlayMode.UntilDone)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.collectible, function (sprite3, otherSprite2) {
    info.changeScoreBy(1)
    music.playSoundEffect(music.createSoundEffect(WaveShape.Noise, 5000, 1, 255, 213, 500, SoundExpressionEffect.Warble, InterpolationCurve.Logarithmic), SoundExpressionPlayMode.UntilDone)
    page.destroy(effects.disintegrate, 500)
})
sprites.onDestroyed(SpriteKind.collectable, function (sprite2) {
...
scene.setBackgroundImage(img`
    ...
    ................................................................................................................................................................
    `)
game.showLongText("An attack from a weird shadow monster is haunting will, can you find the correct pages before the shadow lets us meet our doom? (this is not based on the series, only the characters ", DialogLayout.Bottom)
scene.setBackgroundImage(img`
...
for (let index = 0; index < 4; index++) {
    music.playMelody("E F G A B A G F ", 285)
}
...
scene.setBackgroundImage(img`
    ...
    fffffffffffffffffffffdddddddddddddddddddddddddddddddddddddddddddbbbbbbdddddddddddddddddddddddddddddddddddddddbbbbbbddddddddddddddddddddddddddddddddddddddddddddd
    `)
let lucas = sprites.create(assets.image`lucas`, SpriteKind.Player)
controller.moveSprite(lucas)
scaling.scaleToPercent(lucas, 150, ScaleDirection.Uniformly, ScaleAnchor.Middle)
lucas.setBounceOnWall(true)
page = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
